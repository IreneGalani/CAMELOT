...
## Running the app
Για να τρέξετε την εφαρμογή κατεβάζετε το camelot.exe αρχείο ως εξής:πατάτε στο φάκελο του και στη συνέχεια download.Εν συνεχεία,ανοίγοντας το αρχείο λήψεων στον υπολογιστή σας και πατώντας πάνω στο αρχείο που κατέβηκε είστε έτοιμος να παίξετε το παιχνιδί.
